...
description: |
  ...
  and hybrid integration with another networking layer.
---
...
## 4. Identity Bridge (identity layer ↔ libp2p)

Both the identity layer and libp2p support ed25519 keypairs. The same seed can derive both identities:
