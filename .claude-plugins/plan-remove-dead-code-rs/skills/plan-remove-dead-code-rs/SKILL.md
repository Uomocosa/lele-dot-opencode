...
description: Use when searching for Rust files whose primary pub item has zero internal consumers in a crate's src/. Searches for use crate:: references, then presents candidates for user evaluation.
---
